...
def train_model(model, features, labels, epochs=10, batch_size=32, folder='checkpoint', resume_checkpoint=None,
    ...
    for epoch in range(start_epoch, epochs):
        ...
        log_message(
            ...
            f'Train Loss: {epoch_loss:.4f}, Train Acc: {epoch_acc:.2f}%, AvgPosProb: {avg_pos_prob:.4f}, '
...
if __name__ == "__main__":
    ...
    # 设置要恢复的检查点路径
    resume_checkpoint_path = None  # 例如: 'checkpoint_one_class/epoch10.pth'
