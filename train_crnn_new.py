...
if __name__ == "__main__":
    ...
    resume_checkpoint_path = 'checkpoint1/epoch75.pth' # 例如: 'checkpoint1/epoch15.pth'

    # 开始训练
    train_model(model, features, labels, epochs=100, batch_size=16, folder='checkpoint1', resume_checkpoint=resume_checkpoint_path)